...
export default function TitleArticles() {
  return (
    <Head>
      ...
      />
      <title>Articles by Shivam Tiwari</title>
      <meta
        name="description"
        content="Explore articles authored by Shivam Tiwari, a Full Stack Engineer and Developer."
      />
